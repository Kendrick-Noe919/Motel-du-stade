...
CREATE TABLE `chambres` (
  ...
  `etat` enum('DISPONIBLE','RESERVEE','OCCUPEE','NETTOYAGE','MAINTENANCE','HORS_SERVICE') NOT NULL DEFAULT 'DISPONIBLE',
...
INSERT INTO `chambres` VALUES (10,'001','OCCUPEE',1,4),(11,'002','DISPONIBLE',1,5),(12,'003','NETTOYAGE',2,4),(13,'004','DISPONIBLE',NULL,5);
...
--
-- Table structure for table `journal_operations`
--

DROP TABLE IF EXISTS `journal_operations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `journal_operations` (
  ...
  `avant` varchar(191) DEFAULT NULL,
  `apres` varchar(191) DEFAULT NULL,
  `utilisateurId` int(11) DEFAULT NULL,
  `auteurNom` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `journal_operations_dateOperation_idx` (`dateOperation`),
  KEY `journal_operations_cibleType_cibleId_idx` (`cibleType`,`cibleId`),
  KEY `journal_operations_utilisateurId_idx` (`utilisateurId`),
  CONSTRAINT `journal_operations_utilisateurId_fkey` FOREIGN KEY (`utilisateurId`) REFERENCES `utilisateurs` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `journal_operations`
--

LOCK TABLES `journal_operations` WRITE;
/*!40000 ALTER TABLE `journal_operations` DISABLE KEYS */;
INSERT INTO `journal_operations` VALUES (1,'2026-08-14 12:28:23.748','CHAMBRE_ETAT','chambre',12,'Chambre 003 : DISPONIBLE vers NETTOYAGE','DISPONIBLE','NETTOYAGE',3,'dbz Krilin'),(2,'2026-08-14 13:46:46.144','CHAMBRE_ETAT','chambre',11,'Chambre 002 : DISPONIBLE vers HORS_SERVICE','DISPONIBLE','HORS_SERVICE',1,'koelo noe'),(3,'2026-08-14 13:46:46.191','CHAMBRE_ETAT','chambre',11,'Chambre 002 : HORS_SERVICE vers DISPONIBLE','HORS_SERVICE','DISPONIBLE',1,'koelo noe'),(4,'2026-08-14 13:46:46.291','PARAMETRE_MODIFIE','parametre',NULL,'Délai avant expiration d\'une réservation : 2 vers 3 heures','2','3',1,'koelo noe'),(5,'2026-08-14 13:46:46.321','PARAMETRE_MODIFIE','parametre',NULL,'Délai avant expiration d\'une réservation : 3 vers 2 heures','3','2',1,'koelo noe'),(8,'2026-08-14 14:30:33.870','RESERVATION_EXPIREE','reservation',17,'Réservation #17 expirée automatiquement après 2h sans confirmation','EN_ATTENTE','EXPIREE',NULL,'Système'),(9,'2026-08-14 14:58:47.724','CHAMBRE_CREEE','chambre',13,'Chambre 004 créée (Chambre Luxieuse)',NULL,NULL,1,'koelo noe');
/*!40000 ALTER TABLE `journal_operations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `notifications` (
  ...
  `roleCible` varchar(191) DEFAULT NULL,
  `utilisateurCibleId` int(11) DEFAULT NULL,
  `lue` tinyint(1) NOT NULL DEFAULT 0,
  `dateLecture` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `notifications_roleCible_lue_idx` (`roleCible`,`lue`),
  KEY `notifications_utilisateurCibleId_lue_idx` (`utilisateurCibleId`,`lue`),
  CONSTRAINT `notifications_utilisateurCibleId_fkey` FOREIGN KEY (`utilisateurCibleId`) REFERENCES `utilisateurs` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `notifications` VALUES (1,'2026-08-14 14:30:33.883','RESERVATION_EXPIREE','Réservation expirée','La réservation de xxx Abdou (chambre 002) a expiré, la chambre est de nouveau disponible.','/reservations','STANDARDISTE',NULL,0,NULL),(2,'2026-08-14 14:58:47.735','CHAMBRE_AJOUTEE','Nouvelle chambre disponible','La chambre 004 (Chambre Luxieuse) est désormais réservable.','/chambres','STANDARDISTE',NULL,0,NULL);
...
INSERT INTO `parametres` VALUES ('EXPIRATION_RESERVATION_HEURES','2','Délai avant expiration d\'une réservation','Une réservation encore en attente passée ce délai est annulée automatiquement et la chambre redevient disponible.','heures','2026-08-14 13:46:46.315'),('TAMPON_NETTOYAGE_HEURES','1','Tampon avant une arrivée','Une chambre réservée reste louable jusqu\'à ce délai avant l\'arrivée prévue, pour laisser le temps du nettoyage.','heures','2026-08-14 13:29:41.230');
...
CREATE TABLE `reservations` (
  ...
  `statut` enum('EN_ATTENTE','CONFIRMEE','EN_COURS','TERMINEE','ANNULEE','EXPIREE') NOT NULL DEFAULT 'EN_ATTENTE',
...
INSERT INTO `reservations` VALUES (16,'2026-08-13 20:46:38.552','2026-08-14 00:00:00.000','2026-08-15 00:00:00.000',1,15000.00,'EN_COURS','RECEPTION',10,10,'2026-08-13 20:46:38.552','2026-08-14 11:16:54.929','NUITEE',NULL,NULL),(17,'2026-08-14 12:26:42.366','2026-08-22 00:00:00.000','2026-08-30 00:00:00.000',8,400000.00,'EXPIREE','RECEPTION',11,11,'2026-08-14 12:26:42.366','2026-08-14 14:30:33.855','NUITEE',NULL,3);
...
INSERT INTO `roles` VALUES (1,'Administrateur général','Accès global : supervision, paramètres, recettes détaillées et historique.','ADMIN'),(3,'Standardiste','Accueil, réservations, séjours, clients, encaissements et sa caisse.','STANDARDISTE'),(4,'Caissier','Contrôle des caisses du poste et du bar, rapprochement et rapport de journée.','CAISSIER'),(6,'Barman','Restauration, minibar, blanchisserie, ventes et sa caisse.','BARMAN');
...
INSERT INTO `types_chambre` VALUES (4,'Chambre Standard',15000.00,2,'Cette chambre est très spacieuse',5000.00,5000.00,NULL),(5,'Chambre Luxieuse',50000.00,4,'Chambre composée d\'une bainoire etc....',16667.00,16667.00,NULL);
...
INSERT INTO `utilisateur_roles` VALUES (1,1,1),(5,2,4),(6,3,3),(7,4,6),(8,5,3);
...
-- Dump completed on 2026-08-14 15:19:33
